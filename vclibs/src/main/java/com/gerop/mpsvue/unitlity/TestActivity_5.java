...
import com.gerop.mpsvue.databinding.ActivityTest5Binding;
...
public class TestActivity_5 extends AppCompatActivity {
    private static final String TAG = "TestActivity_5";
    ...
    private ActivityTest5Binding binding5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding5 = DataBindingUtil.setContentView(this, R.layout.activity_test_5);
        ...
        binding5.animText.startAnimation(anim);

        myCountdownTimer = new CountDownTimer(31000, 1000) {

            public void onTick(long millisUntilFinished) {
                //mTextField.setText("seconds remaining: " + millisUntilFinished / 1000);
                binding5.cntrDown.setText("00:" + millisUntilFinished / 1000);
            }

            public void onFinish() {
                myCountdownTimer.cancel();
                Toast.makeText(TestActivity_5.this, "No User Found!", Toast.LENGTH_SHORT).show();
                next_call();
            }
        }.start();
        ...
        binding5.cancelConnect.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void next_call() {
        startActivity(new Intent(TestActivity_5.this, MainHomeActivity.class).putExtra("rate", true));
        finish();
    }
    ...
    public void onBackPressed() {
        try {
            TestActivity_5.this.runOnUiThread(new Runnable() {
                public void run() {
                    int Vibration = 200;
                    myCountdownTimer.cancel();
                    ...
                    Toast.makeText(TestActivity_5.this, "Call Disconnected", Toast.LENGTH_SHORT).show();
                }
            });
            if (socket != null) {
                sendMessage("bye");
    ...
    private void initializeSurfaceViews() {
        ...
        binding5.surfaceView.init(rootEglBase.getEglBaseContext(), null);
        binding5.surfaceView.setEnableHardwareScaler(true);
        binding5.surfaceView.setMirror(true);

        binding5.surfaceView2.init(rootEglBase.getEglBaseContext(), null);
        binding5.surfaceView2.setEnableHardwareScaler(true);
        binding5.surfaceView2.setMirror(true);
    ...
    private void createVideoTrackFromCameraAndShowIt() {
        ...
        videoTrackFromCamera.addRenderer(new VideoRenderer(binding5.surfaceView));
        ...
        PeerConnection.Observer pcObserver = new PeerConnection.Observer() {
            ...
            public void onIceCandidate(IceCandidate iceCandidate) {
                ...
                try {
                    if (!rep) {
                        ...
                        TestActivity_5.this.runOnUiThread(new Runnable() {
                            public void run() {
                                int Vibration = 200;
                                myCountdownTimer.cancel();
                                Toast.makeText(TestActivity_5.this, "Call Connected", Toast.LENGTH_SHORT).show();
                                Vibrator v = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                    v.vibrate(VibrationEffect.createOneShot(Vibration, VibrationEffect.DEFAULT_AMPLITUDE));
                                } else {
                    ...
                    TestActivity_5.this.runOnUiThread(new Runnable() {
                        public void run() {
                            binding5.connectionMask.setVisibility(View.GONE);
                        }
                    });
            ...
            public void onAddStream(MediaStream mediaStream) {
                ...
                remoteVideoTrack.addRenderer(new VideoRenderer(binding5.surfaceView2));
            }
    ...
    public void speakerONOFFEvent(View view) {
        if (!audioManager.isSpeakerphoneOn()) {
            binding5.audioSpeaker.setImageResource(R.drawable.on_speker);
            ...
            binding5.audioSpeaker.setImageResource(R.drawable.off_speker);
    ...
    public void audioMuteEvent(View view) {
        ...
        if (audioManager.isMicrophoneMute()) {
            binding5.audioMute.setImageResource(R.drawable.mic_on);
            audioManager.setMicrophoneMute(false);
        } else {
            binding5.audioMute.setImageResource(R.drawable.mic_off);
        ...
        ((TextView) dialog.findViewById(R.id.reyes)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (c1.isChecked() || c2.isChecked() || c3.isChecked() || c4.isChecked() || c5.isChecked() || c6.isChecked() || c7.isChecked()) {
                    Toast.makeText(TestActivity_5.this, "Report Submitted", Toast.LENGTH_SHORT).show();
                    onBackPressed();
                    dialog.dismiss();
                } else {
                    Toast.makeText(TestActivity_5.this, "Select Report Reason", Toast.LENGTH_SHORT).show();
                }
            }
        });
        dialog.show();
