...
import com.gerop.mpsvue.databinding.ActivityTest7Binding;
...
public class TestActivity_7 extends AppCompatActivity {
    ...
    private ActivityTest7Binding binding7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding7 = DataBindingUtil.setContentView(this, R.layout.activity_test_7);
        ...
        binding7.animText.startAnimation(anim);

        myCountdownTimer = new CountDownTimer(31000, 1000) {

            public void onTick(long millisUntilFinished) {
                //mTextField.setText("seconds remaining: " + millisUntilFinished / 1000);
                binding7.cntrDown.setText("00:" + millisUntilFinished / 1000);
            }
        ...
        binding7.cancelConnect.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initializeSurfaceViews() {
        ...
        binding7.surfaceView.init(rootEglBase.getEglBaseContext(), null);
        binding7.surfaceView.setEnableHardwareScaler(true);
        binding7.surfaceView.setMirror(true);

        binding7.surfaceView2.init(rootEglBase.getEglBaseContext(), null);
        binding7.surfaceView2.setEnableHardwareScaler(true);
        binding7.surfaceView2.setMirror(true);
    ...
    private void createVideoTrackFromCameraAndShowIt() {
        ...
        videoTrackFromCamera.addRenderer(new VideoRenderer(binding7.surfaceView));
        ...
        PeerConnection.Observer pcObserver = new PeerConnection.Observer() {
            ...
            public void onIceCandidate(IceCandidate iceCandidate) {
                ...
                try {
                    ...
                    TestActivity_7.this.runOnUiThread(new Runnable() {
                        public void run() {
                            binding7.connectionMask.setVisibility(View.GONE);
                        }
                    });
            ...
            public void onAddStream(MediaStream mediaStream) {
                ...
                remoteVideoTrack.addRenderer(new VideoRenderer(binding7.surfaceView2));
            }
    ...
    public void speakerONOFFEvent(View view) {
        if (!audioManager.isSpeakerphoneOn()) {
            binding7.audioSpeaker.setImageResource(R.drawable.on_speker);
            ...
            binding7.audioSpeaker.setImageResource(R.drawable.off_speker);
    ...
    public void audioMuteEvent(View view) {
        ...
        if (audioManager.isMicrophoneMute()) {
            binding7.audioMute.setImageResource(R.drawable.mic_on);
            audioManager.setMicrophoneMute(false);
        } else {
            binding7.audioMute.setImageResource(R.drawable.mic_off);
