...
public class TestActivity_4 extends AppCompatActivity {
    private static final String TAG = "TestActivity_4_4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myCountdownTimer = new CountDownTimer(31000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(TestActivity_4.this, "No User Found!", Toast.LENGTH_SHORT).show();
                next_call();
            }
        }.start();
    ...
    public void next_call() {
        startActivity(new Intent(TestActivity_4.this, MainHomeActivity.class).putExtra("rate", true));
        finish();
    }
        ...
        try {
            TestActivity_4.this.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    Toast.makeText(TestActivity_4.this, "Call Disconnected", Toast.LENGTH_SHORT).show();
                }
            });
            if (socket != null) {
                sendMessage("bye");
                    ...
                    if (!rep) {
                        ...
                        TestActivity_4.this.runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                Toast.makeText(TestActivity_4.this, "Call Connected", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
        ...
        ((TextView) dialog.findViewById(R.id.reyes)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (c1.isChecked() || c2.isChecked() || c3.isChecked() || c4.isChecked() || c5.isChecked() || c6.isChecked() || c7.isChecked()) {
                    Toast.makeText(TestActivity_4.this, "Report Submitted", Toast.LENGTH_SHORT).show();
                    onBackPressed();
                    dialog.dismiss();
                } else {
